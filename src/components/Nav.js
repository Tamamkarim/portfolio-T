...
const Nav = () => {
  return <nav className='fixed bottim-2 lg:bottom-8 w-full overflow-hidden z-50'>
  <div className="container mx-auto">
    ...
    items-center text-2x1 text-white/50'>
      ...
      spy={true}
      offset={-200}
      className='cursor-poiter w-[60px] h-[60px]flex items-center 
      justify-center'
      >
        <BiHomeAlt /> 
      </Link>
      ...
      smooth={true}
      spy={true}
      className='cursor-poiter w-[60px] h-[60px]
